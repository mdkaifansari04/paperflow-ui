  ...
  return (
    <div
      ...
      style={{
        ...
        position: "relative",
        ...(accent ? { borderLeft: `4px solid ${accentMap[accent]}` } : {}),
        ...style,
      }}
    >
      {children}
  ...
  return (
    <span
      style={{
        ...
        color:
          variant === "solid" ? c.text : c.bg === "#1A1209" ? "#1A1209" : c.bg,
...
export const PaperDivider: React.FC<DividerProps> = ({
  ...
  >
    <div
      style={{
        flex: 1,
        height: lineStyle === "double" ? "3px" : "1px",
        borderTop:
          lineStyle === "double"
            ? "3px double #1A1209"
    ...
    {label && (
      <div
        style={{
          flex: 1,
          height: "1px",
          borderTop: `1px ${lineStyle} #1A1209`,
        }}
      />
    )}
  </div>
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          A design system for people who think interfaces should feel like they
          were <Highlight>made with care</Highlight>, not{" "}
        ...
        >
          <PaperBadge color="ink" variant="solid">
            v1.0.0
          </PaperBadge>
          <PaperBadge color="yellow" variant="solid">
            Paper Design
          </PaperBadge>
          <PaperBadge color="green" variant="solid">
            Open Source
          </PaperBadge>
        </div>
        {/* Decorative rule */}
      ...
      <main style={{ padding: "48px", maxWidth: "1200px", margin: "0 auto" }}>
        ...
        <Section title="Badges & Tags" annotation="labels for the labeled">
          ...
          >
            ...
            <PaperBadge color="red" variant="solid">
              Breaking
            </PaperBadge>
            <PaperBadge color="blue" variant="solid">
              Info
            </PaperBadge>
            <PaperBadge color="orange" variant="solid">
              WIP
            </PaperBadge>
            <PaperBadge color="ink" variant="outline">
              Next.js
            </PaperBadge>
            <PaperBadge color="blue" variant="outline">
              React
            </PaperBadge>
          </div>
        </Section>
        ...
        <Section title="Cards" annotation="stacked like a messy desk">
          ...
          >
            <PaperCard shadow="lift2">
              ...
              >
                A brief description of something I made that actually worked.
                Most of the time.
              </p>
            ...
            <PaperCard shadow="lift3" accent="yellow">
              ...
              >
                Left border accent in yellow. Use sparingly — like all good
                things.
              </p>
            </PaperCard>
            ...
            <PaperCard
              shadow="lift1"
              style={{ background: "#1A1209", color: "#F5F0E8" }}
            >
              <div
                style={{
                  fontFamily: "'JetBrains Mono', monospace",
              ...
              >
                For contrast. Like turning the page over.
              </p>
            </PaperCard>
          </div>
        </Section>
        ...
        <Section
          title="Sticky Notes"
          annotation="ideas that haven't graduated yet"
        >
          <div
            style={{
              display: "flex",
        ...
        <Section title="Inline Elements" annotation="the spice rack">
          <div style={{ maxWidth: "640px" }}>
            <p
              style={{ fontSize: "1.1rem", lineHeight: 1.85, color: "#2C2416" }}
            >
              Great design is{" "}
              <Highlight color="yellow">always intentional</Highlight>. Even the
              parts that look accidental — especially those.{" "}
              <Annotation>trust me on this one</Annotation> The goal is to make
              something that feels <Highlight color="green">made</Highlight>,
              not generated.
            </p>
          </div>
        </Section>
